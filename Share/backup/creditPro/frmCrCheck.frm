...
Begin VB.Form frmCrCheck 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "Select Customer To Check Outstanding Balance"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
...
Private Sub Command1_Click()
    ...
    DEnv.rsCommand5.Filter = "(Name='" & Combo1.Text & "')"
